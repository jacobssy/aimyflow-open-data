...
[AimyFlow で完全版の役割ページを開く](https://www.aimyflow.com/ja/role/residential-architect)
...
- **住空間計画**: 動線や採光、収納を踏まえて住まいの空間構成を整える。
- **法規・確認申請図書**: 住宅の法規や用途地域に適合する図面と申請資料をまとめる。
- **住宅ディテール設計**: 外壁、屋根、開口部、防水の納まりを施工可能な形で詳細化する。
- **材料・仕上げ選定**: 耐久性、手入れ、予算、住空間の印象を踏まえて材料と仕上げを選ぶ。
- **現場施工調整**: 現場の進捗確認や質疑対応を行い、図面・仕様・設計意図との整合を保つ。
...
- [roomdesign-pro](https://www.aimyflow.com/ja/ai/roomdesign-pro): Room Design は、住宅所有者やインテリアデザイナーが部屋の写真をアップロードし、スタイルを適用して、写真のようにリアルな再デザイン、バーチャルリノベーション、家具のマッチ提案、色や照明の提案を生成できる無料の AI ルームデザイナーです。インテリアデザインやリノベーション業務では、詳細な計画に入る前に部屋の写真を素早く視覚的な選択肢へ変換することで、コンセプト検討やクライアントとのコミュニケーションを加速できます。

## AimyFlow で続きを見る

- [すべての AI ツールを見る](https://www.aimyflow.com/ja/explore)
- [すべての役割を見る](https://www.aimyflow.com/ja/roles)
- [コミュニティ投票を見る](https://www.aimyflow.com/ja/role/residential-architect)
