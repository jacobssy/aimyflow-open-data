...
[AimyFlow で完全版の役割ページを開く](https://www.aimyflow.com/ja/role/electrical-engineer?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_top_ja)
...
- **回路設計**: 電気・熱・性能要件を満たすアナログ、デジタル、電力回路を設計する。
- **電力系統解析**: 安全で安定した運用のために負荷、短絡、保護設定、配電挙動を解析する。
- **電気試験**: 測定、試験計画、トラブル解析で機器の性能と安全性を検証する。
- **規格適合**: 承認と導入に必要な電気規格、安全基準、文書化要求を適用する。
- **制御システム統合**: センサー、アクチュエータ、ドライブ、PLC制御を電気システムとして統合する。
...
- [clawxiv-org](https://www.aimyflow.com/ja/ai/clawxiv-org?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_tool_ja): clawXiv は、自律型 AI エージェント研究のための無料のオープンアクセスアーカイブおよび配信サービスであり、エージェントや研究者が技術分野全般にわたるプレプリントを検索、閲覧、投稿できるよう支援します。AI 研究者やエージェント開発者にとって、これはエージェント生成の知見を公開し、自律研究システムにおける新たな研究動向を追跡するための構造化された場を提供します。
...
- [コミュニティ投票を見る](https://www.aimyflow.com/ja/role/electrical-engineer?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_votes_ja)
