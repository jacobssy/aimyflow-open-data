...
[AimyFlow で完全版の役割ページを開く](https://www.aimyflow.com/ja/role/molecular-biologist?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_top_ja)
...
- **実験設計**: 適切な対照と評価項目を備えた分子実験を設計する。
- **核酸操作**: DNA・RNA抽出、PCR、クローニングを正確に実施する。
- **遺伝子発現解析**: qPCRやシーケンスなどで遺伝子発現データを測定・解釈する。
- **配列データ解釈**: 配列品質を評価し、変異や構築配列を生物学的課題に結び付ける。
- **実験記録管理**: 再現性と遵守に向けて記録、試薬履歴、手順改訂を管理する。
...
- [pdfdigest-com](https://www.aimyflow.com/ja/ai/pdfdigest-com?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_tool_ja): PDFdigestは、ユーザーが学術PDFをアップロードし、簡潔で構造化された解説とナレーション付きの要約動画を取得できるAI搭載の研究理解プラットフォームであり、主に学生、研究者、学術関係者を対象としています。AIを活用した研究ワークフローにおいて、これらの専門職が複雑な論文をより迅速にレビューし、難解な知見をより理解しやすい学習資料へと変換するのに役立ちます。
- [scisummary-com](https://www.aimyflow.com/ja/ai/scisummary-com?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_tool_ja): SciSummaryは、研究者や学生が科学論文や研究論文を要約・分析・整理できるよう支援するAI研究ツールであり、構造化されたセクション、図の解釈、参考文献管理に対応しています。学術研究者、アナリスト、大学院生にとって、依拠する論文構造を保ちながら難解な研究を実用的な要約へと変換することで、文献レビューや論文比較を迅速化できます。
...
- [コミュニティ投票を見る](https://www.aimyflow.com/ja/role/molecular-biologist?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_votes_ja)
