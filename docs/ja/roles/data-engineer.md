...
[AimyFlow で完全版の役割ページを開く](https://www.aimyflow.com/ja/role/data-engineer?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_top_ja)
...
- [alumnium-ai](https://www.aimyflow.com/ja/ai/alumnium-ai?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_tool_ja): Alumnium は、AI を活用したテスト自動化ツールであり、人が読めるテスト指示を、主に Python、Playwright、Selenium、Appium などのフレームワークを使用するソフトウェアおよび QA エンジニア向けに、実行可能なブラウザおよびモバイルのコマンドへ変換します。AI 支援によるテストワークフローでは、QA チームやソフトウェアエンジニアリングチームが、テストロジックと検証の制御を維持しながら、信頼性の高い自動テストをより迅速に作成・保守するのに役立ちます。
- [anakin-io](https://www.aimyflow.com/ja/ai/anakin-io?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_tool_ja): Anakin.io は、開発者やデータチームが、JavaScript を多用するページ、保護されたページ、認証が必要なページを含むウェブサイトから、Markdown、JSON、HTML としてコンテンツや構造化データを抽出できるよう支援する Web スクレイピング API プラットフォームです。AI エンジニア、アナリスト、自動化チームにとっては、ウェブデータを下流のモデルやワークフロー向けのよりクリーンな入力に変換することで、RAG パイプライン、市場調査、リード獲得、モニタリングを効率化できます。
- [antigravity-google](https://www.aimyflow.com/ja/ai/antigravity-google?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_tool_ja): Google Antigravityは、型破りなオンライン体験やデジタル製品との新しい関わり方を探る実験的なGoogleプロジェクトです。AI時代に、プロダクトやデザインチームへ独創的なUI発想のヒントを与えます。
- [app-imagine-bo](https://www.aimyflow.com/ja/ai/app-imagine-bo?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_tool_ja): Imagine.bo は、創業者、クリエイター、小規模チームが、平易な英語のアイデアを、生成されたフロントエンド、バックエンド、デプロイ、そして必要に応じたエンジニア支援を備えたウェブサイトや実用的なアプリへと変換できるよう支援する、AI アプリ構築プラットフォームです。スタートアップの立ち上げ担当者やプロダクトチームにとって、MVP の作成を加速し、インフラ、セキュリティチェック、ローンチ準備に費やす時間を削減できます。
...
- [コミュニティ投票を見る](https://www.aimyflow.com/ja/role/data-engineer?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_votes_ja)
