...
[AimyFlow で完全版の役割ページを開く](https://www.aimyflow.com/ja/role/Business-Operations-Specialists)
...
業務運営専門職 向けのこのページでは、関連する AI ツール 43 件と主要スキル 5 件をまとめ、GitHub 上で素早く全体像を確認できるようにしています。特に 業務プロセス改善, 運営レポーティング, 部門横断調整 の観点が目立ち、最新の投票や詳細な workflow は AimyFlow 本体で確認できます。

## 主要スキル

- **業務プロセス改善**: 業務フローを分析し、ボトルネック解消と効率向上を進める。
- **運営レポーティング**: KPIや傾向、業務実績を把握するレポートやダッシュボードを作成する。
- **部門横断調整**: 関連部門、日程、引き継ぎを調整し、施策の進行を維持する。
- **規程運用**: 運用ルールや統制を実装し、業務の適正性と一貫性を保つ。
- **リソース計画**: 人員、予算、業務キャパシティを計画し、需要変動に備える。
...
- [コミュニティ投票を見る](https://www.aimyflow.com/ja/role/Business-Operations-Specialists)
