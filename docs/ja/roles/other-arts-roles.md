...
[AimyFlow で完全版の役割ページを開く](https://www.aimyflow.com/ja/role/Other-Arts-Roles?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_top_ja)
...
- **芸術リサーチ**: 表現の方向性を支える資料や文脈を調査する。
- **コンセプト開発**: テーマや表現案を一貫した芸術コンセプトにまとめる。
- **制作計画**: 日程、資材、空間、技術要件を整理して制作を進める。
- **媒体・技法選定**: 意図や条件、発表形式に応じて媒体や技法を選ぶ。
- **展示・発表基準**: 設営、記録、取り扱い、鑑賞体験に配慮して作品を整える。
...
- [コミュニティ投票を見る](https://www.aimyflow.com/ja/role/Other-Arts-Roles?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_votes_ja)
