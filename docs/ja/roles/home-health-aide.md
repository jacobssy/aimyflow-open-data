...
[AimyFlow で完全版の役割ページを開く](https://www.aimyflow.com/ja/role/home-health-aide?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_top_ja)
...
- **身体介護**: 入浴・更衣・排泄・移動を安全に支援する。
- **健康観察**: 体調変化や痛み、皮膚異常などの兆候を見て報告する。
- **移乗介助**: ベッドや椅子、トイレ間の移乗を安全に介助する。
- **食事支援**: 食事準備や食事介助を行い、食事制限や嚥下への配慮を守る。
- **介護記録**: 行った介助内容や日々の様子、変化を記録してケア継続に役立てる。
...
- [superpower-com-ai-doctor](https://www.aimyflow.com/ja/ai/superpower-com-ai-doctor?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_tool_ja): Superpowerは、100種類以上のバイオマーカーのモニタリング、血液検査結果の理解、臨床家の裏付けがある推奨事項とコンシェルジュサポートに基づく個別化された健康プランの実行を支援する健康検査・ケアプラットフォームです。AIを活用した予防医療ワークフローにおいて、医療・ウェルネスの専門家が複雑な検査データを、継続的な健康管理のための、より明確で迅速な次のステップの指針へと変換するのに役立ちます。
...
- [コミュニティ投票を見る](https://www.aimyflow.com/ja/role/home-health-aide?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_votes_ja)
