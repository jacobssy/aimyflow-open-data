...
[AimyFlow で完全版の役割ページを開く](https://www.aimyflow.com/ja/role/street-muralist?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_top_ja)
...
- **壁面下地処理**: 屋外壁面を洗浄・補修し、耐候性に合う下地と塗料を整える。
- **大画面構成**: 見え方や壁面比率、街の文脈を踏まえて大画面の構図を設計する。
- **拡大転写**: グリッドや投影、フリーハンドで下図を大きな壁面へ正確に移す。
- **スプレー筆致制御**: スプレーと筆で線、塗り、ぼかし、エッジ、重ね塗りを使い分ける。
- **現場安全管理**: 許可申請や高所作業、通行環境を踏まえて安全な制作体制を組む。
...
- [コミュニティ投票を見る](https://www.aimyflow.com/ja/role/street-muralist?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_votes_ja)
