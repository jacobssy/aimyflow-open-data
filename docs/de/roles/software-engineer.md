...
[Vollständige Rollen-Seite auf AimyFlow öffnen](https://www.aimyflow.com/de/role/software-engineer)

## Überblick

- Zugeordnete Tools: 323
- Skill-Karten: 5

## Kernkompetenzen

- **Systemdesign**: Entwirft skalierbare Services, Datenflüsse und Schnittstellen passend zu Produkt- und Betriebsanforderungen.
- **Code-Implementierung**: Implementiert wartbaren Anwendungscode mit klarer Struktur, passenden Abstraktionen und verlässlichem Verhalten.
- **Testen und Qualität**: Definiert Tests, prüft Änderungen und erkennt Regressionen, bevor Software in Produktion geht.
- **Performance-Optimierung**: Analysiert Engpässe und verbessert Latenz, Durchsatz und Ressourcennutzung unter realen Lasten.
- **Deployment und Betrieb**: Bringt Software sicher über Build-Pipelines, Releases, Monitoring und Incident-Handling in den Betrieb.
...
- [Community-Votings ansehen](https://www.aimyflow.com/de/role/software-engineer)
