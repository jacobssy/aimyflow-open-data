# Sonstige Bildungsrollen

[Vollständige Rollen-Seite auf AimyFlow öffnen](https://www.aimyflow.com/de/role/Other-Education-Roles)
...
Diese Seite für Sonstige Bildungsrollen bündelt 27 passende KI-Tools und 5 Kernkompetenzen, damit Suchnutzer auf GitHub schnell die Relevanz einschätzen können. In diesem Snapshot stechen vor allem Lernstandsdiagnostik, Programmplanung, Curriculum-Unterstützung hervor; Live-Rankings, Votings und tiefere Workflows liegen weiterhin auf AimyFlow.

## Kernkompetenzen

- **Lernstandsdiagnostik**: Erfasst Lernfortschritte mit passenden Verfahren und nutzt die Ergebnisse für pädagogische Entscheidungen.
- **Programmplanung**: Strukturiert Bildungsangebote, Zeitpläne, Ressourcen und Ziele für eine wirksame Umsetzung.
- **Curriculum-Unterstützung**: Passt Lernmaterialien und Unterrichtsstrukturen an Ziele und Lernbedarfe an.
- **Bildungskonformität**: Setzt Vorgaben zu Schutz, Dokumentation, Datenschutz und Richtlinien im Alltag um.
- **Lehrbetriebskoordination**: Koordiniert Zeitpläne, Lernlogistik und Beteiligte, damit Bildungsabläufe reibungslos funktionieren.
...
- [Community-Votings ansehen](https://www.aimyflow.com/de/role/Other-Education-Roles)
