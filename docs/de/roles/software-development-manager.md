...
[Vollständige Rollen-Seite auf AimyFlow öffnen](https://www.aimyflow.com/de/role/software-development-manager)

## Überblick

- Zugeordnete Tools: 298
- Skill-Karten: 5

## Kernkompetenzen

- **Technische Roadmap**: Übersetzt Produktziele in Engineering-Phasen, Abhängigkeiten und Liefermeilensteine.
- **Architektur-Governance**: Steuert Designentscheidungen, damit Systeme skalierbar, wartbar und teamübergreifend konsistent bleiben.
- **Liefersteuerung**: Steuert Umfang, Kapazität und Umsetzungsrisiken, um verlässliche Releases termingerecht zu liefern.
- **Engineering Operations**: Verbessert den Entwicklungsfluss durch Metriken, Werkzeuge, CI/CD-Praktiken und Incident-Feedbackschleifen.
- **Sicherheits- und Compliance-Steuerung**: Stellt sicher, dass Lieferpraktiken über den gesamten Lebenszyklus Sicherheits-, Datenschutz- und Regulatorikvorgaben erfüllen.
...
- [Community-Votings ansehen](https://www.aimyflow.com/de/role/software-development-manager)
