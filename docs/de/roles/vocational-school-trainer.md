...
- **Curriculum-Abstimmung**: Stimmt Lerninhalte auf Berufsstandards, Prüfungsziele und betriebliche Anforderungen ab.
- **Praxisanleitung**: Vermittelt Werkzeuge, Techniken und Abläufe und begleitet praktische Übungen sicher.
- **Kompetenzbewertung**: Bewertet Leistungen anhand praktischer Kriterien und dokumentiert den Kompetenzstand verlässlich.
- **Sicherheitsvorgaben**: Setzt Sicherheitsregeln, Geräteprüfungen und Risikomaßnahmen im Ausbildungsbereich konsequent um.
- **Praxisnahe Trainingsplanung**: Plant Lernaufgaben und Projekte nach realen Arbeitsprozessen, Werkzeugen und Qualitätsstandards.
