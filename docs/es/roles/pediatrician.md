...
[Abrir la página completa del rol en AimyFlow](https://www.aimyflow.com/es/role/pediatrician?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_top_es)
...
- **Evaluación pediátrica**: Evalúa crecimiento, desarrollo, signos vitales y síntomas según la edad para detectar enfermedades a tiempo.
- **Gestión de vacunación**: Planifica calendarios de vacunación, revisa contraindicaciones y controla seguridad y seguimiento.
- **Atención pediátrica aguda**: Diagnostica y trata enfermedades urgentes frecuentes en lactantes, niños y adolescentes con decisiones ajustadas a la edad.
- **Seguimiento de patologías crónicas**: Controla enfermedades de largo plazo como asma o diabetes y ajusta el tratamiento conforme el niño crece.
- **Cribado del desarrollo**: Detecta problemas del desarrollo, la conducta y el aprendizaje, y coordina derivaciones oportunas.
...
- [Ver la votación de la comunidad](https://www.aimyflow.com/es/role/pediatrician?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_votes_es)
