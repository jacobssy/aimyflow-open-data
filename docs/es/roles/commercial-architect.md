...
[Abrir la página completa del rol en AimyFlow](https://www.aimyflow.com/es/role/commercial-architect)

## Resumen

- Herramientas asociadas: 12
- Tarjetas de habilidades: 5

## Habilidades clave

- **Planificación del programa**: Traduce las necesidades de operación, clientes e inquilinos en un programa funcional viable.
- **Planificación comercial**: Organiza circulaciones, frentes y locales para favorecer ventas y flujo de clientes.
- **Cumplimiento normativo**: Desarrolla proyectos que cumplen normativa de incendio, accesibilidad, zonificación y uso comercial.
- **Integración de fachada y marca**: Coordina fachada, señalética y materiales con la identidad de marca y las exigencias urbanísticas.
- **Documentación constructiva**: Prepara planos y detalles coordinados para licencia, licitación y ejecución del acondicionamiento comercial.
...
- [focaupscaler-com](https://www.aimyflow.com/es/ai/focaupscaler-com): Foca AI es un mejorador y ampliador de imágenes con IA y conciencia física que ayuda a los usuarios a restaurar detalles auténticos, texturas y nitidez en fotos y gráficos de baja resolución, principalmente para diseñadores, fotógrafos, estudios y profesionales centrados en la imagen. Para flujos de trabajo creativos y de comercio electrónico, su enfoque centrado en la fidelidad puede ayudar a los equipos a mejorar imágenes listas para impresión y fotografías de productos sin introducir detalles inventados.
...
- [Ver la votación de la comunidad](https://www.aimyflow.com/es/role/commercial-architect)
