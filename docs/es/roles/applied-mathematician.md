...
- **Modelización matemática**: Formula sistemas reales como modelos matemáticos tratables con supuestos y límites explícitos.
- **Derivación analítica**: Deriva ecuaciones gobernantes, aproximaciones y resultados cerrados para explicar el comportamiento.
- **Métodos numéricos**: Diseña y evalúa esquemas numéricos para simulación, optimización o resolución de ecuaciones a escala.
- **Validación de modelos**: Contrasta las predicciones del modelo con datos, cuantifica el error e identifica condiciones de fallo.
- **Formulación de optimización**: Traduce objetivos operativos y restricciones en problemas de optimización resolubles con fiabilidad.
