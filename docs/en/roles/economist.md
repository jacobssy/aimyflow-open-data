...
[Open full role page on AimyFlow](https://www.aimyflow.com/en/role/economist?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_top_en)
...
- **Economic Modeling**: Builds and calibrates models to explain markets, growth, inflation, or policy effects.
- **Econometric Analysis**: Applies statistical methods to estimate relationships, test hypotheses, and identify causal effects.
- **Forecasting**: Produces forecasts for key indicators and updates scenarios as new data and risks emerge.
- **Policy Evaluation**: Assesses how regulations, fiscal measures, or public programs affect welfare, incentives, and outcomes.
- **Data Interpretation**: Interprets macroeconomic, financial, and survey data to produce defensible economic insights.
...
- [See community voting](https://www.aimyflow.com/en/role/economist?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_votes_en)
