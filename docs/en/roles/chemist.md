...
[Open full role page on AimyFlow](https://www.aimyflow.com/en/role/chemist?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_top_en)
...
- **Analytical Testing**: Performs chemical analyses with validated methods to identify composition, purity, and trace impurities.
- **Method Development**: Designs and optimizes laboratory methods so results are reliable, reproducible, and fit for purpose.
- **Reaction Design**: Selects reagents, conditions, and pathways to achieve target compounds with controlled yield and selectivity.
- **Data Interpretation**: Interprets spectra, chromatograms, and experimental results to confirm structures and explain observed behavior.
- **Lab Safety Compliance**: Applies chemical safety, waste handling, and documentation rules to keep laboratory work compliant and controlled.
...
- [See community voting](https://www.aimyflow.com/en/role/chemist?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_votes_en)
