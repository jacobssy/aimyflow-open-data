...
[Ouvrir la page complète du rôle sur AimyFlow](https://www.aimyflow.com/fr/role/software-development-manager?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_top_fr)
...
- **Feuille de route technique**: Traduit les objectifs produit en phases d’ingénierie, dépendances et jalons de livraison.
- **Gouvernance d’architecture**: Cadre les choix de conception pour garder des systèmes évolutifs, maintenables et cohérents entre équipes.
- **Pilotage des livraisons**: Gère le périmètre, la capacité et les risques d’exécution pour livrer des versions fiables dans les délais.
- **Opérations d’ingénierie**: Améliore le flux de développement via les métriques, l’outillage, le CI/CD et les retours d’incident.
- **Supervision sécurité et conformité**: Veille à ce que les pratiques de livraison respectent les exigences de sécurité, de confidentialité et de conformité sur tout le cycle.
...
- [Voir les votes de la communauté](https://www.aimyflow.com/fr/role/software-development-manager?utm_source=github&utm_medium=repo&utm_campaign=open_data&utm_content=role_doc_votes_fr)
