...
- **Analyse structurelle**: Calcule les charges, les contraintes et la stabilité pour valider des structures sûres et efficaces.
- **Évaluation géotechnique**: Interprète les données de sol, de nappe et de site pour définir les fondations et contraintes de terrassement.
- **Documents d’exécution**: Élabore les plans, spécifications et quantités nécessaires à une exécution et des achats fiables.
- **Conformité réglementaire**: Applique les codes de calcul, règles de sécurité et exigences d’autorisation tout au long du projet.
- **Suivi de chantier**: Contrôle l’exécution, les matériaux et l’avancement pour garantir la conformité au projet et à la qualité.
