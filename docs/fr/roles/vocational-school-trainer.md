...
- **Alignement pédagogique**: Aligne les contenus sur les référentiels professionnels, les certifications et les attentes du métier.
- **Encadrement pratique**: Montre les outils, gestes et procédés tout en encadrant la pratique en sécurité.
- **Évaluation des compétences**: Évalue les acquis selon des critères pratiques et trace le niveau de maîtrise atteint.
- **Sécurité en atelier**: Fait appliquer les règles de sécurité, les contrôles du matériel et la prévention des risques.
- **Conception métier**: Conçoit des activités et projets calés sur les प्रक्रés, outils et exigences qualité du terrain.
