...
- **Gestion documentaire**: Assure un classement, une conservation et une recherche fiables des documents opérationnels et réglementaires.
- **Coordination des agendas**: Coordonne les agendas, réunions, réservations de salles et actions de suivi entre plusieurs interlocuteurs.
- **Conformité administrative**: Applique les procédures internes et les exigences réglementaires aux opérations et documents administratifs courants.
- **Traitement des dépenses**: Prépare, vérifie et transmet les factures, remboursements et justificatifs d’achat avec les pièces requises.
- **Support aux opérations de bureau**: Assure le bon fonctionnement quotidien du bureau en gérant fournitures, demandes de service et coordination courante.
